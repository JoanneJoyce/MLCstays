...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'middle_name' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_type'], 'references' => ['user_types', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'birthday' => '2017-07-06 14:26:20',
            'user_type' => 1,
            'created' => '2017-07-06 14:26:20',
            'modified' => '2017-07-06 14:26:20'
        ],
    ];
}
